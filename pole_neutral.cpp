...
#include <iostream>
#include <sstream>
pole_neutral::pole_neutral(int krok,int x1, int y1,int x2, int y2,int x3, int y3,int x4, int y4): pole(x1,y1,x2,y2,x3,y3,x4,y4)
{
    this->krok = krok;
    kolor=sf::Color::Blue;
...
pole_neutral::~pole_neutral()
{

}
void pole_neutral::rysuj(sf::RenderWindow &okno)
{
    float delta = 0.2;
    sf::Vertex vertices[] =
    {
